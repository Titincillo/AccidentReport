...
Partial Class Admin_Default
    ...
    Dim clasficacion As New DataSetTableAdapters.ClasificacionTableAdapter
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If actualizar.Text = "" Then
            ...
            End If
        ElseIf clasficacion.ConsultarNombre(actualizar.Text).Rows.Count > 0 Then
            ...
            actualizar.Focus()
        Else
            clasficacion.actualizar(actualizar.Text, GridView1.SelectedRow.Cells(1).Text)
            GridView1.DataBind()

...
Partial Class Admin_Default
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If actualizar.Text = "" Then
            ...
            End If
        ElseIf especialidad.ConsultarNombre(actualizar.Text).Rows.Count > 0 Then
            Dim mensaje As String = "Especialidad ya se encuentra registrada"
            Dim strScript As String = "<script language=JavaScript>"
            strScript += "alert(""" & mensaje & """);"
            strScript += "</script>"
            If (Not ClientScript.IsStartupScriptRegistered("clientScript")) Then
            ...
            actualizar.Focus()
        Else
            especialidad.actualizar(actualizar.Text, GridView1.SelectedRow.Cells(1).Text)
            GridView1.DataBind()

...
Partial Class Admin_Default
    ...
    Protected Sub DataGrid1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        DropDownList1.SelectedValue = HttpUtility.HtmlDecode(GridView1.SelectedRow.Cells(3).Text)
    End Sub
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If actualizar.Text = "" Then
            ...
            End If
        ElseIf ciudad.ConsultarNombre(actualizar.Text).Rows.Count > 0 Then
            ...
            actualizar.Focus()
        Else
            ciudad.actualizar(actualizar.Text, DropDownList1.SelectedValue, GridView1.SelectedRow.Cells(1).Text)
            GridView1.DataBind()
